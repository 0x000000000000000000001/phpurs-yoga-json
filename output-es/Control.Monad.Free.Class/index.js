...
const monadFreeFree = {
  wrapFree: /* #__PURE__ */ Control$dSemigroupoid.composeImpl(m => Control$dMonad$dFree.bindImpl(m)(Control$dBind.identity))(Control$dMonad$dFree.liftF),
  Monad0: () => Control$dMonad$dFree.monadFree
};
