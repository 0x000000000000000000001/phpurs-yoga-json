...
const genYear = dictMonadGen => dictMonadGen.Monad0().Bind1().Apply0().Functor0().map(Control$dSemigroupoid.composeImpl(v => {
  if (v.tag === "Just") { return v._1; }
  $runtime.fail();
})(Data$dDate$dComponent.boundedEnumYear.toEnum))(dictMonadGen.chooseInt(1900)(2100));
