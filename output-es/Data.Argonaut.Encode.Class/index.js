...
const encodeJsonArray = dictEncodeJson => ({encodeJson: Control$dSemigroupoid.composeImpl(Data$dArgonaut$dCore.fromArray)(Data$dFunctor.arrayMap(dictEncodeJson.encodeJson))});
...
const encodeJsonList = dictEncodeJson => (
  {
    encodeJson: Control$dSemigroupoid.composeImpl(Data$dArgonaut$dCore.fromArray)(Control$dSemigroupoid.composeImpl(Data$dFunctor.arrayMap(dictEncodeJson.encodeJson))(Data$dArgonaut$dEncode$dEncoders.toUnfoldable))
  }
);
...
const encodeJsonNonEmptyArray = dictEncodeJson => (
  {
    encodeJson: Control$dSemigroupoid.composeImpl(Control$dSemigroupoid.composeImpl(Data$dArgonaut$dCore.fromArray)(Data$dFunctor.arrayMap(dictEncodeJson.encodeJson)))(Data$dArray$dNonEmpty.toArray)
  }
);
const encodeJsonNonEmptyList = dictEncodeJson => ({encodeJson: Data$dArgonaut$dEncode$dEncoders.encodeNonEmptyList(dictEncodeJson.encodeJson)});
...
const encodeSet = dictOrd => dictEncodeJson => ({encodeJson: Data$dArgonaut$dEncode$dEncoders.encodeSet(dictOrd)(dictEncodeJson.encodeJson)});
...
const encodeForeignObject = dictEncodeJson => (
  {encodeJson: Control$dSemigroupoid.composeImpl(Data$dArgonaut$dCore.fromObject)(Foreign$dObject.functorObject.map(dictEncodeJson.encodeJson))}
);
export {
  encodeForeignObject,
  encodeIdentity,
