...
const isUpper = /* #__PURE__ */ (() => Control$dSemigroupoid.composeImpl(Data$dCodePoint$dUnicode$dInternal.uIswupper)(Data$dString$dCodePoints.boundedEnumCodePoint.fromEnum))();
const isSpace = c => {
  if (c <= 823) { return c === 32 || c >= 9 && c <= 13 || c === 160; }
  return Data$dCodePoint$dUnicode$dInternal.checkAttrS([2])(c);
};
const isPrint = /* #__PURE__ */ (() => Control$dSemigroupoid.composeImpl(Data$dCodePoint$dUnicode$dInternal.uIswprint)(Data$dString$dCodePoints.boundedEnumCodePoint.fromEnum))();
const isOctDigit = c => {
  const diff = c - 48 | 0;
...
const isLower = /* #__PURE__ */ (() => Control$dSemigroupoid.composeImpl(Data$dCodePoint$dUnicode$dInternal.uIswlower)(Data$dString$dCodePoints.boundedEnumCodePoint.fromEnum))();
const isLatin1 = c => c <= Data$dString$dCodePoints.codePointFromChar("ÿ");
const isDecDigit = c => {
  const diff = c - 48 | 0;
...
const isControl = /* #__PURE__ */ (() => Control$dSemigroupoid.composeImpl(Data$dCodePoint$dUnicode$dInternal.uIswcntrl)(Data$dString$dCodePoints.boundedEnumCodePoint.fromEnum))();
const isAsciiUpper = c => c >= Data$dString$dCodePoints.codePointFromChar("A") && c <= Data$dString$dCodePoints.codePointFromChar("Z");
const isAsciiLower = c => c >= Data$dString$dCodePoints.codePointFromChar("a") && c <= Data$dString$dCodePoints.codePointFromChar("z");
const isAscii = c => c < Data$dString$dCodePoints.codePointFromChar("");
const isAlphaNum = /* #__PURE__ */ (() => Control$dSemigroupoid.composeImpl(Data$dCodePoint$dUnicode$dInternal.uIswalnum)(Data$dString$dCodePoints.boundedEnumCodePoint.fromEnum))();
const isAlpha = /* #__PURE__ */ (() => Control$dSemigroupoid.composeImpl(Data$dCodePoint$dUnicode$dInternal.uIswalpha)(Data$dString$dCodePoints.boundedEnumCodePoint.fromEnum))();
...
const generalCategory = /* #__PURE__ */ (() => Control$dSemigroupoid.composeImpl(v1 => {
  if (v1.tag === "Just") { return Data$dMaybe.$Maybe("Just", unicodeCatToGeneralCat(v1._1)); }
  return Data$dMaybe.Nothing;
})(Control$dSemigroupoid.composeImpl(Data$dCodePoint$dUnicode$dInternal.uGencat)(Data$dString$dCodePoints.boundedEnumCodePoint.fromEnum)))();
const isLetter = c => {
