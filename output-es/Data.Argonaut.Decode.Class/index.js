...
const decodeMap = dictOrd => dictDecodeJson => {
  const decodeJson1 = dictDecodeJson.decodeJson;
  return dictDecodeJson1 => ({decodeJson: Data$dArgonaut$dDecode$dDecoders.decodeMap(dictOrd)(decodeJson1)(dictDecodeJson1.decodeJson)});
};
const decodeSet = dictOrd => dictDecodeJson => ({decodeJson: Data$dArgonaut$dDecode$dDecoders.decodeSet(dictOrd)(dictDecodeJson.decodeJson)});
