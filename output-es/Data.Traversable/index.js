  ...
  return dictTraversable1 => {
    ...
    return {
      traverse: dictApplicative => {
        const Functor0 = dictApplicative.Apply0().Functor0();
        return f => {
          const $2 = Control$dSemigroupoid.composeImpl(Functor0.map(Control$dSemigroupoid.composeImpl(Data$dFunctor$dCoproduct.Coproduct)(Data$dEither.Left)))(dictTraversable.traverse(dictApplicative)(f));
          const $3 = Control$dSemigroupoid.composeImpl(Functor0.map(Control$dSemigroupoid.composeImpl(Data$dFunctor$dCoproduct.Coproduct)(Data$dEither.Right)))(dictTraversable1.traverse(dictApplicative)(f));
          return v2 => {
      ...
      sequence: dictApplicative => {
        const Functor0 = dictApplicative.Apply0().Functor0();
        const $2 = Control$dSemigroupoid.composeImpl(Functor0.map(Control$dSemigroupoid.composeImpl(Data$dFunctor$dCoproduct.Coproduct)(Data$dEither.Left)))(dictTraversable.sequence(dictApplicative));
        const $3 = Control$dSemigroupoid.composeImpl(Functor0.map(Control$dSemigroupoid.composeImpl(Data$dFunctor$dCoproduct.Coproduct)(Data$dEither.Right)))(dictTraversable1.sequence(dictApplicative));
        return v2 => {
          if (v2.tag === "Left") { return $2(v2._1); }
          if (v2.tag === "Right") { return $3(v2._1); }
          $runtime.fail();
