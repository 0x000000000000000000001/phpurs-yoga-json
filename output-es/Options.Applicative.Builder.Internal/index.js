...
const mkCommand = m => {
  ...
  return Data$dTuple.$Tuple(
    v.cmdGroup,
    Data$dTuple.$Tuple(
      Data$dFunctor.arrayMap(Data$dTuple.fst)($0),
      Data$dTuple.$Tuple(v1 => Data$dFoldable.lookup(Data$dFoldable.foldableArray)(Data$dEq.eqString)(v1)($0), undefined)
    )
  );
};
...
const modSemigroup = {
  append: v => v1 => $Mod(
    Control$dSemigroupoid.composeImpl(v1._1)(v._1),
    $DefaultProp(v1._2._1.tag === "Nothing" ? v._2._1 : v1._2._1, v1._2._2.tag === "Nothing" ? v._2._2 : v1._2._2),
    Control$dSemigroupoid.composeImpl(v1._3)(v._3)
  )
};
...
const modMonoid = {mempty: /* #__PURE__ */ $Mod(identity1, /* #__PURE__ */ $DefaultProp(Data$dMaybe.Nothing, Data$dMaybe.Nothing), identity), Semigroup0: () => modSemigroup};
const optionMod = /* #__PURE__ */ Mod(identity1)(/* #__PURE__ */ $DefaultProp(Data$dMaybe.Nothing, Data$dMaybe.Nothing));
