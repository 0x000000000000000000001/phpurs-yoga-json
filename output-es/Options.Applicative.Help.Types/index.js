...
const helpText = v => extractChunk(Options$dApplicative$dHelp$dChunk.vsepChunks([v.helpError, v.helpSuggestions, v.helpHeader, v.helpUsage, v.helpBody, v.helpFooter]));
const renderHelp = cols => Control$dSemigroupoid.composeImpl(Text$dPrettyPrint$dLeijen.displayS)(Control$dSemigroupoid.composeImpl(Text$dPrettyPrint$dLeijen.renderFits(Text$dPrettyPrint$dLeijen.fits1)(1.0)(cols))(helpText));
const parserHelpShow = {
  show: /* #__PURE__ */ Control$dSemigroupoid.composeImpl(Data$dShow.showStringImpl)(/* #__PURE__ */ Control$dSemigroupoid.composeImpl(Text$dPrettyPrint$dLeijen.displayS)(/* #__PURE__ */ Control$dSemigroupoid.composeImpl(/* #__PURE__ */ Text$dPrettyPrint$dLeijen.renderFits(Text$dPrettyPrint$dLeijen.fits1)(1.0)(80))(helpText)))
};
export {ParserHelp, chunkMonoid, extractChunk, helpText, newtypeParserHelp, parserHelpMonoid, parserHelpSemigroup, parserHelpShow, renderHelp};
