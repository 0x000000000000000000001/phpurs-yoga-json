...
const parseFlags = s => (
  {
    global: Control$dSemigroupoid.composeImpl(Data$dMaybe.isJust)(Data$dString$dCodeUnits.indexOf("g"))(s),
    ignoreCase: Control$dSemigroupoid.composeImpl(Data$dMaybe.isJust)(Data$dString$dCodeUnits.indexOf("i"))(s),
    multiline: Control$dSemigroupoid.composeImpl(Data$dMaybe.isJust)(Data$dString$dCodeUnits.indexOf("m"))(s),
    dotAll: Control$dSemigroupoid.composeImpl(Data$dMaybe.isJust)(Data$dString$dCodeUnits.indexOf("s"))(s),
    sticky: Control$dSemigroupoid.composeImpl(Data$dMaybe.isJust)(Data$dString$dCodeUnits.indexOf("y"))(s),
    unicode: Control$dSemigroupoid.composeImpl(Data$dMaybe.isJust)(Data$dString$dCodeUnits.indexOf("u"))(s)
  }
);
const match = /* #__PURE__ */ _match(Data$dMaybe.Just)(Data$dMaybe.Nothing);
const flags = /* #__PURE__ */ Control$dSemigroupoid.composeImpl(Data$dString$dRegex$dFlags.RegexFlags)(flagsImpl);
