...
const stripPrefix = dictEq => v => s => Control$dMonad$dRec$dClass.monadRecMaybe.tailRecM(o => {
  if (o.b.tag === "Cons" && o.a.tag === "Cons") {
    if (dictEq.eq(o.a._1)(o.b._1)) { return Data$dMaybe.$Maybe("Just", Control$dMonad$dRec$dClass.$Step("Loop", {a: o.a._2, b: o.b._2})); }
    return Data$dMaybe.Nothing;
  }
  if (o.a.tag === "Nil") { return Data$dMaybe.$Maybe("Just", Control$dMonad$dRec$dClass.$Step("Done", o.b)); }
  return Data$dMaybe.Nothing;
})({a: v, b: s});
const span = v => v1 => {
...
const sortBy = cmp => {
  ...
  return Control$dSemigroupoid.composeImpl(mergeAll)(sequences);
};
const sort = dictOrd => {
...
const nubBy = p => {
  ...
  return Control$dSemigroupoid.composeImpl(reverse)(go(Data$dList$dInternal.Leaf)(Data$dList$dTypes.Nil));
};
...
const groupAllBy = p => Control$dSemigroupoid.composeImpl(groupBy(x => y => p(x)(y) === "EQ"))(sortBy(p));
const group = dictEq => groupBy(dictEq.eq);
const groupAll = dictOrd => Control$dSemigroupoid.composeImpl(group(dictOrd.Eq0()))((() => {
  const compare = dictOrd.compare;
  return xs => sortBy(compare)(xs);
})());
