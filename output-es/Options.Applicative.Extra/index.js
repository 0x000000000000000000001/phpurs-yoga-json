...
const renderFailure = failure => progn => {
  ...
  return Data$dTuple.$Tuple(
    Control$dSemigroupoid.composeImpl(Text$dPrettyPrint$dLeijen.displayS)(Control$dSemigroupoid.composeImpl(Text$dPrettyPrint$dLeijen.renderFits(Text$dPrettyPrint$dLeijen.fits1)(1.0)(v._2._2._1))(Options$dApplicative$dHelp$dTypes.helpText))(v._1),
    v._2._1
  );
};
const parserFailure = pprefs => pinfo => msg => ctx => {
  const suggestion_help = {
    ...
    helpSuggestions: (() => {
      if (msg.tag === "UnexpectedError") {
        ...
        if ($1.tag === "Just") {
          const $2 = Control$dSemigroupoid.composeImpl(Options$dApplicative$dHelp$dChunk.vcatChunks)(Data$dFunctor.arrayMap(Options$dApplicative$dHelp$dChunk.stringChunk))(good);
          if ($2.tag === "Just") {
  ...
  return progn => Data$dTuple.$Tuple(
    (() => {
      const $0 = (names, pinfo$p) => Data$dFoldable.foldableArray.foldMap(Options$dApplicative$dHelp$dTypes.parserHelpMonoid)(Data$dFoldable.identity1)([
        (() => {
          ...
          if (show_full_help) {
            return Data$dFoldable.foldableArray.foldMap(Options$dApplicative$dHelp$dTypes.parserHelpMonoid)(Data$dFoldable.identity1)([
              $0,
              f,
              Options$dApplicative$dHelp$dCore.parserHelp(pprefs)(pinfo$p.infoParser)
            ]);
          }
...
const helper = /* #__PURE__ */ (() => Options$dApplicative$dBuilder.abortOption(Options$dApplicative$dTypes.ShowHelpText)(Data$dFoldable.foldableArray.foldMap(Options$dApplicative$dBuilder$dInternal.modMonoid)(Data$dFoldable.identity1)([
  Control$dSemigroupoid.composeImpl(Options$dApplicative$dBuilder$dInternal.fieldMod)(Control$dSemigroupoid.composeImpl(Options$dApplicative$dBuilder$dInternal.optionFieldsHasName.name)(Options$dApplicative$dTypes.OptLong))("help"),
  Control$dSemigroupoid.composeImpl(Options$dApplicative$dBuilder$dInternal.fieldMod)(Control$dSemigroupoid.composeImpl(Options$dApplicative$dBuilder$dInternal.optionFieldsHasName.name)(Options$dApplicative$dTypes.OptShort))("h"),
...
const hsubparser = m => {
  ...
  return Options$dApplicative$dBuilder$dInternal.mkParser(v._2)(v._3)(Options$dApplicative$dTypes.$OptReader(
    ...
    v1._1,
    v1._2._1,
    Control$dSemigroupoid.composeImpl(v1$1 => {
      if (v1$1.tag === "Just") {
        return Data$dMaybe.$Maybe(
          "Just",
          {...v1$1._1, infoParser: Options$dApplicative$dInternal$dUtils.apApplyFlipped(Options$dApplicative$dTypes.parserApply)(v1$1._1.infoParser)(helper)}
        );
      }
      return Data$dMaybe.Nothing;
    })(v1._2._2._1)
...
const execParserPure = pprefs => pinfo => args => {
  const v = Control$dSemigroupoid.composeImpl(Control$dMonad$dReader.runReader)(Control$dSemigroupoid.composeImpl(a => a([]))(Control$dMonad$dExcept$dTrans.runExceptT))(Options$dApplicative$dCommon.runParserFully(Options$dApplicative$dInternal.pMonadP)(pinfo.infoPolicy)(Options$dApplicative$dTypes.$Parser(
    "AltP",
