...
const round = /* #__PURE__ */ Control$dSemigroupoid.composeImpl(unsafeClamp)(Data$dNumber.round);
const trunc = /* #__PURE__ */ Control$dSemigroupoid.composeImpl(unsafeClamp)(Data$dNumber.trunc);
const floor = /* #__PURE__ */ Control$dSemigroupoid.composeImpl(unsafeClamp)(Data$dNumber.floor);
const even = x => (x & 1) === 0;
const parity = n => {
...
const ceil = /* #__PURE__ */ Control$dSemigroupoid.composeImpl(unsafeClamp)(Data$dNumber.ceil);
