...
const checkFractionalUse = v => {
  const $0 = Data$dList.span(Control$dSemigroupoid.composeImpl(a => Data$dNumber.floor(a) === a)(Data$dTuple.snd))(v.asList);
  if (
    $0.rest.tag === "Cons" && Data$dList$dTypes.foldableList.foldMap(monoidAdditive)(Control$dSemigroupoid.composeImpl(Control$dSemigroupoid.composeImpl(Data$dMonoid$dAdditive.Additive)(Data$dNumber.abs))(Data$dTuple.snd))($0.rest._2) > 0.0
  ) {
...
const checkValidIsoDuration = v => Data$dFoldable.foldableArray.foldMap(monoidFn)(Data$dFoldable.identity1)([
  ...
  asList: (() => {
    ...
    return go(Data$dList$dTypes.Nil)(Control$dSemigroupoid.composeImpl(b => {
          ...
          if (v$1.tag === "Nothing") {
            const go$2 = go$2$a0$copy => go$2$a1$copy => {
              ...
              while (go$2$c) {
                ...
                if (v$2.tag === "Cons") {
                  go$2$a0 = Data$dList$dTypes.$List("Cons", v$2._1, b$1);
                  go$2$a1 = v$2._2;
                  continue;
                }
                $runtime.fail();
      ...
      return go$1(b)(Data$dList$dTypes.Nil);
    })(Data$dMap$dInternal.toMapIter)(v));
  })(),
  asMap: v
});
