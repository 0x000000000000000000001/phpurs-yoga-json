...
const options = v => Foreign$dObject.fromFoldable(Data$dFoldable.foldableArray)(v);
...
const opt = /* #__PURE__ */ Control$dSemigroupoid.composeImpl(Data$dOp.Op)(defaultToOptions);
...
export {Options, assoc, defaultToOptions, monoidOptions, newtypeOptions, opt, optional, options, semigroupOptions, tag};
