...
const fromList = l => {
  const v = Data$dList$dLazy$dTypes.step(l);
...
const fromFoldable = dictFoldable => Control$dSemigroupoid.composeImpl(fromList)(dictFoldable.foldr(Data$dList$dLazy$dTypes.cons)(Data$dList$dLazy$dTypes.nil));
