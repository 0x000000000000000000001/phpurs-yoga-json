...
const bindProduct = dictBind => {
  ...
  return dictBind1 => {
    ...
    return {
      bind: v => f => Data$dTuple.$Tuple(
        dictBind.bind(v._1)(Control$dSemigroupoid.composeImpl(Data$dTuple.fst)(Control$dSemigroupoid.composeImpl(Unsafe$dCoerce.unsafeCoerce)(f))),
        dictBind1.bind(v._2)(Control$dSemigroupoid.composeImpl(Data$dTuple.snd)(Control$dSemigroupoid.composeImpl(Unsafe$dCoerce.unsafeCoerce)(f)))
      ),
      Apply0: () => applyProduct2
    };
  };
};
