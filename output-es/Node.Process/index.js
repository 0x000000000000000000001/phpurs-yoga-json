...
const showRecord = {show: record => "{ system: " + Data$dShow.showIntImpl(record.system) + ", user: " + Data$dShow.showIntImpl(record.user) + " }"};
const identity = x => x;
const showCpuUsage = {show: v => "(CpuUsage " + showRecord.show(v) + ")"};
