...
const startsWith = pat => Control$dSemigroupoid.composeImpl(Data$dMaybe.isJust)(stripPrefix(pat));
...
const endsWith = pat => Control$dSemigroupoid.composeImpl(Data$dMaybe.isJust)(stripSuffix(pat));
const dropWhile = p => s => drop(countPrefix(p)(s))(s);
const dropRight = i => s => take(length(s) - i | 0)(s);
const contains = pat => Control$dSemigroupoid.composeImpl(Data$dMaybe.isJust)(indexOf(pat));
