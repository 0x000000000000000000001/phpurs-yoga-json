...
const diff = dictDuration => dt1 => dt2 => dictDuration.toDuration(dt1 + Control$dSemigroupoid.composeImpl(Data$dTime$dDuration.identity)(Control$dSemigroupoid.composeImpl(Data$dTime$dDuration.negate)(Data$dTime$dDuration.identity))(dt2));
