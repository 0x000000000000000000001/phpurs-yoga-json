...
const toInstant = /* #__PURE__ */ (() => {
  const $0 = Control$dSemigroupoid.composeImpl(Data$dDateTime$dInstant.instant)(Data$dTime$dDuration.Milliseconds);
  const $1 = toInstantImpl(Data$dMaybe.Just)(Data$dMaybe.Nothing);
  return a => {
    const $2 = $1(a);
    if ($2.tag === "Just") { return $0($2._1); }
    if ($2.tag === "Nothing") { return Data$dMaybe.Nothing; }
    $runtime.fail();
  };
})();
const toISOString = dt => dateMethodEff("toISOString", dt);
const toDateTime = /* #__PURE__ */ Control$dSemigroupoid.composeImpl(v1 => {
  if (v1.tag === "Just") { return Data$dMaybe.$Maybe("Just", Data$dDateTime$dInstant.toDateTime(v1._1)); }
  return Data$dMaybe.Nothing;
})(toInstant);
const toDateString = dt => dateMethod("toDateString", dt);
const toDate = /* #__PURE__ */ Control$dSemigroupoid.composeImpl(v1 => {
