...
const unfoldable1Array = {
  unfoldr1: /* #__PURE__ */ unfoldr1ArrayImpl(Data$dMaybe.isNothing)(v => {
...
const replicate1A = dictApply => dictUnfoldable1 => dictTraversable1 => n => m => dictTraversable1.sequence1(dictApply)(dictUnfoldable1.unfoldr1(i => {
...
export {iterateN, range, replicate1, replicate1A, singleton, unfoldable1Array, unfoldable1Maybe, unfoldr1};
