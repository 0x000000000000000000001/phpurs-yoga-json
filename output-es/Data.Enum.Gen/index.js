...
const genBoundedEnum = dictMonadGen => {
  const Applicative0 = dictMonadGen.Monad0().Applicative0();
  return dictBoundedEnum => {
    ...
    if (v.tag === "Just") {
      return Control$dMonad$dGen.elements(dictMonadGen)(foldable1NonEmpty)(Data$dNonEmpty.$NonEmpty(
        Bounded0.bottom,
        Data$dEnum.enumFromTo(Enum1)(Data$dUnfoldable1.unfoldable1Array)(v._1)(Bounded0.top)
      ));
    }
    if (v.tag === "Nothing") { return Applicative0.pure(Bounded0.bottom); }
    $runtime.fail();
  };
};
