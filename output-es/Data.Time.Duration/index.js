...
const negateDuration = dictDuration => Control$dSemigroupoid.composeImpl(dictDuration.toDuration)(Control$dSemigroupoid.composeImpl(negate)(dictDuration.fromDuration));
...
const convertDuration = dictDuration => {
  const fromDuration1 = dictDuration.fromDuration;
  return dictDuration1 => Control$dSemigroupoid.composeImpl(dictDuration1.toDuration)(fromDuration1);
};
export {
  Days,
  Hours,
