...
const eqNonEmptyList = {
  eq: x => y => eqGraphicsParam.eq(x._1)(y._1) && (() => {
    const go = v => v1 => v2 => {
      if (!v2) { return false; }
...
const eqEscapeCode = {
  eq: x => y => {
    ...
    if (x.tag === "Graphics") { return y.tag === "Graphics" && eqNonEmptyList.eq(x._1)(y._1); }
...
const ordNonEmptyList = /* #__PURE__ */ Data$dList$dTypes.ordNonEmpty(ordGraphicsParam);
const ordEscapeCode = {
  compare: x => y => {
    if (x.tag === "Up") {
    ...
    if (x.tag === "Graphics") {
      if (y.tag === "Graphics") { return ordNonEmptyList.compare(x._1)(y._1); }
      return Data$dOrdering.LT;
    }
...
const escapeCodeToString = /* #__PURE__ */ Control$dSemigroupoid.composeImpl(v => "\u001b[" + v)(c => {
  if (c.tag === "Up") { return Data$dShow.showIntImpl(c._1) + "A"; }
  if (c.tag === "Down") { return Data$dShow.showIntImpl(c._1) + "B"; }
  if (c.tag === "Forward") { return Data$dShow.showIntImpl(c._1) + "C"; }
  if (c.tag === "Back") { return Data$dShow.showIntImpl(c._1) + "D"; }
  if (c.tag === "NextLine") { return Data$dShow.showIntImpl(c._1) + "E"; }
  if (c.tag === "PreviousLine") { return Data$dShow.showIntImpl(c._1) + "F"; }
  if (c.tag === "HorizontalAbsolute") { return Data$dShow.showIntImpl(c._1) + "G"; }
  if (c.tag === "Position") { return Data$dShow.showIntImpl(c._1) + ";" + Data$dShow.showIntImpl(c._2) + "H"; }
  if (c.tag === "EraseData") {
    if (c._1 === "ToEnd") { return "0J"; }
    if (c._1 === "FromBeginning") { return "1J"; }
    if (c._1 === "Entire") { return "2J"; }
    $runtime.fail();
  }
  if (c.tag === "EraseLine") {
    if (c._1 === "ToEnd") { return "0K"; }
    if (c._1 === "FromBeginning") { return "1K"; }
    if (c._1 === "Entire") { return "2K"; }
    $runtime.fail();
  }
  if (c.tag === "ScrollUp") { return Data$dShow.showIntImpl(c._1) + "S"; }
  if (c.tag === "ScrollDown") { return Data$dShow.showIntImpl(c._1) + "T"; }
  if (c.tag === "Graphics") {
    ...
    return go({init: false, acc: graphicsParamToString(c._1._1)})(Data$dList$dTypes.listMap(graphicsParamToString)(c._1._2)).acc + "m";
  }
  if (c.tag === "SavePosition") { return "s"; }
  if (c.tag === "RestorePosition") { return "u"; }
  if (c.tag === "QueryPosition") { return "6n"; }
  if (c.tag === "HideCursor") { return "?25l"; }
  if (c.tag === "ShowCursor") { return "?25h"; }
  $runtime.fail();
});
export {
  $Color,
