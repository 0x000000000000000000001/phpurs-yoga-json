...
const text = v => {
  if (v === "") { return Empty; }
  return $Doc("Text", Data$dString$dCodePoints.length(v), v);
};
...
const renderCompact = /* #__PURE__ */ (() => {
  ...
  return Control$dSemigroupoid.composeImpl(scan(0))(Data$dList.singleton);
})();
...
const number = f => {
  ...
  if ($0 === "") { return Empty; }
  return $Doc("Text", Data$dString$dCodePoints.length($0), $0);
};
...
const renderFits = fits => rfrac => w => headNode => {
  const $0 = Data$dInt.round(Data$dInt.toNumber(w) * rfrac);
  const v = Data$dOrd.ordInt.compare(w)($0);
  const r = (() => {
    const $1 = (() => {
      if (v === "LT") { return w; }
      if (v === "EQ") { return w; }
    ...
    const v$1 = Data$dOrd.ordInt.compare(0)($1);
    if (v$1 === "LT") { return $1; }
    if (v$1 === "EQ") { return 0; }
    if (v$1 === "GT") { return 0; }
    $runtime.fail();
  ...
  const nicest$p = n => k => i => ds => x => y => {
    ...
    if (
      fits(w)((() => {
        const v$1 = Data$dOrd.ordInt.compare(n)(k);
        if (v$1 === "LT") { return n; }
        if (v$1 === "EQ") { return n; }
        if (v$1 === "GT") { return k; }
        $runtime.fail();
        ...
        const $1 = w - k | 0;
        const $2 = (r - k | 0) + n | 0;
        const v$1 = Data$dOrd.ordInt.compare($1)($2);
        if (v$1 === "LT") { return $1; }
        if (v$1 === "EQ") { return $1; }
        if (v$1 === "GT") { return $2; }
        $runtime.fail();
  ...
  const best = v$1 => v1 => v2 => {
    if (v2.tag === "Nil") { return SEmpty$p; }
    if (v2.tag === "Cons") {
      if (v2._2.tag === "Fail") { return SFail$p; }
      if (v2._2.tag === "Empty") { return best(v$1)(v1)(v2._3); }
      if (v2._2.tag === "Char") {
        const k$p = v1 + 1 | 0;
        return $LazySimpleDoc("SChar'", v2._2._1, Data$dLazy.defer(v3 => best(v$1)(k$p)(v2._3)));
      }
      if (v2._2.tag === "Text") {
        const k$p = v1 + v2._2._1 | 0;
        return $LazySimpleDoc("SText'", v2._2._1, v2._2._2, Data$dLazy.defer(v3 => best(v$1)(k$p)(v2._3)));
      }
      if (v2._2.tag === "Line") { return $LazySimpleDoc("SLine'", v2._1, Data$dLazy.defer(v3 => best(v2._1)(v2._1)(v2._3))); }
      if (v2._2.tag === "FlatAlt") { return best(v$1)(v1)($Docs("Cons", v2._1, v2._2._1, v2._3)); }
      if (v2._2.tag === "Cat") { return best(v$1)(v1)($Docs("Cons", v2._1, v2._2._1, $Docs("Cons", v2._1, v2._2._2, v2._3))); }
      if (v2._2.tag === "Nest") { return best(v$1)(v1)($Docs("Cons", v2._1 + v2._2._1 | 0, v2._2._2, v2._3)); }
      if (v2._2.tag === "Union") { return nicest$p(v$1)(v1)(v2._1)(v2._3)(v2._2._1)(v2._2._2); }
      if (v2._2.tag === "Column") { return best(v$1)(v1)($Docs("Cons", v2._1, v2._2._1(v1), v2._3)); }
      if (v2._2.tag === "Columns") { return best(v$1)(v1)($Docs("Cons", v2._1, v2._2._1(Data$dMaybe.$Maybe("Just", w)), v2._3)); }
      if (v2._2.tag === "Nesting") { return best(v$1)(v1)($Docs("Cons", v2._1, v2._2._1(v2._1), v2._3)); }
    }
    $runtime.fail();
  };
  return forceSimpleDoc(best(0)(0)($Docs("Cons", 0, headNode, Nil)));
};
const foldr1 = dictMonoid => f => Control$dSemigroupoid.composeImpl(v => {
  if (v.tag === "Nothing") { return dictMonoid.mempty; }
  if (v.tag === "Just") { return Data$dFoldable.foldrArray(f)(v._1.last)(v._1.init); }
  $runtime.fail();
})(Data$dArray.unsnoc);
const flatten = v => {
  ...
  if (v.tag === "Column") { return $Doc("Column", Control$dSemigroupoid.composeImpl(flatten)(v._1)); }
  if (v.tag === "Columns") { return $Doc("Columns", Control$dSemigroupoid.composeImpl(flatten)(v._1)); }
  if (v.tag === "Nesting") { return $Doc("Nesting", Control$dSemigroupoid.composeImpl(flatten)(v._1)); }
  return v;
};
...
const docShow = {show: /* #__PURE__ */ Control$dSemigroupoid.composeImpl(displayS)(/* #__PURE__ */ renderFits(fits1)(0.4)(80))};
...
const string = /* #__PURE__ */ Control$dSemigroupoid.composeImpl(xs => Data$dFoldable.foldlArray(v => v1 => {
  if (v.init) { return {init: false, acc: v1}; }
  return {init: false, acc: $Doc("Cat", v.acc, $Doc("Cat", $Doc("FlatAlt", Line, $Doc("Char", " ")), v1))};
})({init: true, acc: Empty})(xs).acc)(/* #__PURE__ */ Control$dSemigroupoid.composeImpl(/* #__PURE__ */ Data$dFunctor.arrayMap(text))(/* #__PURE__ */ Data$dString$dCommon.split("\n")));
...
const hcat = /* #__PURE__ */ foldr1(docMonoid)(beside);
  ...
  k1 => $Doc(
    ...
    $Doc(
      ...
      k2 => {
        ...
        if ($2 === "") { return Empty; }
        return $Doc("Text", Data$dString$dCodePoints.length($2), $2);
      }
    )
  )
);
...
const hsep = /* #__PURE__ */ foldr1(docMonoid)(appendWithSpace);
const appendWithSoftline = x => y => $Doc("Cat", x, $Doc("Cat", softline, y));
const fillSep = /* #__PURE__ */ foldr1(docMonoid)(appendWithSoftline);
const appendWithSoftbreak = x => y => $Doc("Cat", x, $Doc("Cat", softbreak, y));
const fillCat = /* #__PURE__ */ foldr1(docMonoid)(appendWithSoftbreak);
const appendWithLinebreak = x => y => $Doc("Cat", x, $Doc("Cat", $Doc("FlatAlt", Line, Empty), y));
const vcat = /* #__PURE__ */ foldr1(docMonoid)(appendWithLinebreak);
const cat = /* #__PURE__ */ Control$dSemigroupoid.composeImpl(group)(vcat);
const appendWithLine = x => y => $Doc("Cat", x, $Doc("Cat", $Doc("FlatAlt", Line, $Doc("Char", " ")), y));
const vsep = /* #__PURE__ */ foldr1(docMonoid)(appendWithLine);
const sep = /* #__PURE__ */ Control$dSemigroupoid.composeImpl(group)(vsep);
  ...
  return $Doc(
    ...
    k => $Doc(
      ...
      i => $Doc(
        ...
        $Doc(
          "Cat",
          cat(toUnfoldable(Data$dList$dLazy.zipWith(beside)((() => {
            const $0 = Data$dList$dLazy.repeat(sep$p);
            return Data$dLazy.defer(v => Data$dList$dLazy$dTypes.$Step("Cons", left, $0));
          })())(Data$dFoldable.foldrArray(Data$dList$dLazy$dTypes.cons)(Data$dList$dLazy$dTypes.nil)(ds)))),
          right
        )
      )
    )
...
const indent = i => d => {
  ...
  return $Doc(
    "Column",
    k => $Doc("Nesting", i$1 => $Doc("Nest", k - i$1 | 0, $Doc("Nest", i, $Doc("Cat", $0 === "" ? Empty : $Doc("Text", Data$dString$dCodePoints.length($0), $0), d))))
  );
};
export {
  $Doc,
