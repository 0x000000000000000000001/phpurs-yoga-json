...
const fdNext = fd => buff => cb => {
  ...
  return () => {
    const a$p = $0();
    return fdRead(fd)(buff)(0)(Node$dBuffer$dImmutable.size(a$p))(Data$dMaybe.Nothing)(cb)();
  };
};
...
const fdAppend = fd => buff => cb => {
  ...
  return () => {
    const a$p = $0();
    return fdWrite(fd)(buff)(0)(Node$dBuffer$dImmutable.size(a$p))(Data$dMaybe.Nothing)(cb)();
  };
};
