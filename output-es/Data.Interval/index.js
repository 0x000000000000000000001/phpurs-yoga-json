...
const foldableRecurringInterval = {
  foldl: f => i => Control$dSemigroupoid.composeImpl(v2 => {
    if (v2.tag === "StartEnd") { return f(f(i)(v2._1))(v2._2); }
    if (v2.tag === "DurationEnd") { return f(i)(v2._2); }
    if (v2.tag === "StartDuration") { return f(i)(v2._1); }
    return i;
  })(interval),
  foldr: f => i => Control$dSemigroupoid.composeImpl(foldableInterval.foldr(f)(i))(interval),
  foldMap: dictMonoid => {
    const Semigroup0 = dictMonoid.Semigroup0();
    const mempty = dictMonoid.mempty;
...
const bifoldableRecurringInterval = {
  bifoldl: f => g => i => Control$dSemigroupoid.composeImpl(v3 => {
    if (v3.tag === "StartEnd") { return g(g(i)(v3._1))(v3._2); }
    if (v3.tag === "DurationEnd") { return g(f(i)(v3._1))(v3._2); }
    if (v3.tag === "StartDuration") { return g(f(i)(v3._2))(v3._1); }
    if (v3.tag === "DurationOnly") { return f(i)(v3._1); }
    $runtime.fail();
  })(interval),
  bifoldr: f => g => i => Control$dSemigroupoid.composeImpl(bifoldableInterval.bifoldr(f)(g)(i))(interval),
  bifoldMap: dictMonoid => {
    const Semigroup0 = dictMonoid.Semigroup0();
    const mempty = dictMonoid.mempty;
